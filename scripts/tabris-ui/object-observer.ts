...
export function Observed(origin, ownKey, parent) {
...
export function Observable(observed) {
    ...
    function observe(callback) {
        ...
        if (typeof callback !== 'function') {
            throw new Error('observer (callback) parameter MUST be a function');
        }
    ...
    function unobserve() {
        if (isRevoked) {
            throw new TypeError('revoked Observable MAY NOT be unobserved amymore');
        }
        if (arguments.length) {
...
Reflect.defineProperty(Observable, 'from', {
    value: function (target) {
        ...
        var observed = new (<any>Observed)(target),
...
Reflect.defineProperty(this, 'Observable', {value: Observable});
